<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="index.aspx.cs" Inherits="FINTWeb._Default" %>
...
<body>
    ...
    <h4>Login</h4>
        <table id="tbl">
            ...
            <tr>
                <td>
                    <asp:HyperLink ID="nUsrLink" runat="server" 
                        NavigateUrl="~/webForms/RegistrarUsuario.aspx">nuevo usuario</asp:HyperLink>
                </td>
